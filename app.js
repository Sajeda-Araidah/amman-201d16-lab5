 ...
 //console.log( sumOfArray );
  return [productOfArray,
    ' The numbers  ' +testArray[0]+'    '+testArray[1]+'    ' + testArray[2]+ 
         ' have Product of  ' + productOfArray ];
...
function multiplyAnyArray(dynamicArray) {
  ...
  {
    init =init*dynamicArray[i];
    
  }
 
 //console.log( sumOfArray );
  return [init,
    ' The numbers  ' +dynamicArray[0]+'    '+dynamicArray[1]+'    ' + dynamicArray[2]+ '    ' + dynamicArray[3]+ '    ' + dynamicArray[4]+ 
         ' have Product of  ' + init ];
