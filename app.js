...
Write a function called sum() that takes in two numbers as arguments
 and then returns an array where the first element is the sum of those
  numbers, and the second element is a concatenated string that EXACTLY 
...
function sum(a, b) {
  return[ a+b,'The sum of '+ a +' and '+ 7 +  ' is '+ (a+b)+'.'] ;
}
console.log(sum(4,7));
...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and returns
 ...
 of those three numbers,  and the third and fourth elements are strings that EXACTLY follow this example and use the values that were input into the function:
...
Write a function called multiplyArray() that takes an array of numbers as its argument and returns an array
 whose first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input into the function:
...
function multiplyArray(testArray) {
  ...
  for(let i =0;i< testArray.length;i++)
  {
    productOfArray = productOfArray *testArray[i];
    
  }
 
 //console.log( sumOfArray );
  return [productOfArray,
    'The numbers ' +testArray[0]+','+testArray[1]+',' + testArray[2]+ 
         ' have a product of ' + productOfArray+'.'];
...
Write a function called multiplyAnyArray() that takes an array of numbers of any length as its argument
 and returns an array whose first element is the product of those numbers, and the second element is
  a string that EXACTLY follows this example and concatenates a message using the arguments that were passed into the function:
...
to figure out how to do this. However, you may continue to use the + operator for string concatenation.
...
function multiplyAnyArray(testDynamicArray) {
  ...
  {
    init =init*testDynamicArray[i];
    
  }
 
 //console.log( sumOfArray );
  return [init,
    'The numbers ' +testDynamicArray[0]+','+testDynamicArray[1]+',' + testDynamicArray[2]+ ',' + testDynamicArray[3]+ ',' + testDynamicArray[4]+ 
         ' have a product of ' + init+'.' ];
